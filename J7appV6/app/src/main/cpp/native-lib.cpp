...
Java_com_J7app_MainActivity_getNativeMessage(JNIEnv* env, jobject /* this */) {
    std::string message = "hi jk Hello from native C++ code!";
    return env->NewStringUTF(message.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_J7app_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_J7app_MainActivity_initNet(JNIEnv *env, jobject obj, jint num, jintArray siz, jfloatArray bia, jfloatArray we) {
    num_layers = num;
...
extern "C" JNIEXPORT jfloatArray JNICALL Java_com_J7app_MainActivity_inference(JNIEnv *env, jobject job, jfloatArray farr){
    float sum;
